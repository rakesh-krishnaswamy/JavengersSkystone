...
//            autoLib.autonArmUp();
//            autoLib.autonGrab();
//            autoLib.calcMove(backAndForthStoneDistance + foundationAdjustedDistance, slowPower, Constants.Direction.LEFT);
...
//            Thread.sleep(300);
//            autoLib.autonArmDown();
//            autoLib.calcMove(backAndForthStoneDistance, slowPower, Constants.Direction.RIGHT);
//            Thread.sleep(300);  //400
//            autoLib.autonGrab();
//            Thread.sleep(500);  //500
//            autoLib.autonArmUp();
