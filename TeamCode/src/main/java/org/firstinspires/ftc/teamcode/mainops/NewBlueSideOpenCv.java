...
public class NewBlueSideOpenCv extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        int backAndForthStoneDistance = 10;
        int stoneLength = 20;
        int initialMoveDistance = 33;
        int stoneToFoundationDistance = 230;
        int secondStoneDistance = 50;
        int foundationAdjustedDistance = 0;
...
//        distance = autoLib.getDistanceCM();
        if (autoLib.getPipeline().getDetectedPosition() == 0) {
            ...
            telemetry.update();
            autoLib.calcMove(initialMoveDistance, mediumPower, Constants.Direction.BACKWARD);
            autoLib.calcMove(moveToStoneDistance, mediumPower, Constants.Direction.RIGHT);
...
//            autoLib.calcTurn(3, slowPower);
            autoLib.calcMove(backAndForthStoneDistance, mediumPower, Constants.Direction.LEFT);    // move back little
...
//            autoLib.calcMove(stoneToFoundationDistance, mediumPower, Constants.Direction.FORWARD);  // move forward towards foundation
            ...
            autoLib.calcMove(backAndForthStoneDistance + foundationAdjustedDistance, mediumPower, Constants.Direction.RIGHT);
            Thread.sleep(200);
            autoLib.autonArmDown();
            Thread.sleep(200);
            autoLib.autonScore();
            autoLib.autonArmUp();
            autoLib.calcMove(backAndForthStoneDistance + foundationAdjustedDistance, mediumPower, Constants.Direction.LEFT);
//            autoLib.calcMove(stoneToFoundationDistance - secondStoneDistance, mediumPower, Constants.Direction.BACKWARD);  // move forward towards foundation
            autoLib.rampMove(stoneToFoundationDistance - secondStoneDistance, mediumPower, Constants.Direction.BACKWARD, true);  // move forward towards foundation
            //***************Go for 2nd Stone ***************
            Thread.sleep(300);
            autoLib.autonArmDown();
            autoLib.calcMove(backAndForthStoneDistance, mediumPower, Constants.Direction.RIGHT);
            Thread.sleep(300);  //400
            autoLib.autonGrab();
            Thread.sleep(500);  //500
            autoLib.autonArmUp();
            autoLib.calcMove(backAndForthStoneDistance, mediumPower, Constants.Direction.LEFT);    // move back little
//            autoLib.calcMove(stoneToFoundationDistance - secondStoneDistance, mediumPower, Constants.Direction.FORWARD);  // move forward towards foundation
            autoLib.rampMove(stoneToFoundationDistance - secondStoneDistance, mediumPower, Constants.Direction.FORWARD, true);  // move forward towards foundation
            autoLib.calcMove(backAndForthStoneDistance + foundationAdjustedDistance, mediumPower, Constants.Direction.RIGHT);
            Thread.sleep(200);
            autoLib.autonArmDown();
            Thread.sleep(200);
            ...
            telemetry.update();
            autoLib.calcMove((float) (distance), slowPower, Constants.Direction.BACKWARD);
            telemetry.addData("Distance at foundation before latching 1-b", autoLib.getFoundationDistance());
            telemetry.update();
            //Latch while moving 2 cm
            autoLib.calcMove(2, slowPower, Constants.Direction.BACKWARD);
            autoLib.latchServoFoundation();
            autoLib.diagonalMove(150, fullPower, Constants.Direction.FORWARD, true);
